...
const capabilities = [
  ...
  },
  {
    ...
    description: "Automatically validates sender profiles, templates, and routes messages.",
    icon: Route,
    color: "text-white",
  ...
  },
  {
    ...
    description: "If RCS is unavailable, automatically falls back to high-quality SMS routes.",
    icon: Network,
    color: "text-white",
  ...
  },
  {
    ...
    description: "Delivery reports, read receipts, and user events provide complete visibility.",
    icon: Activity,
    color: "text-white",
    bgColor: "bg-[#8B5CF6]", // Purple
  },
