...
const steps = [
  ...
  {
    title: "Smart RCS Gateway",
    desc: "Automatically validates sender profiles, templates, and routes messages.",
    color: "bg-[#FFB26B]",
    icon: <Route size={28} className="text-white" />,
  },
  {
    title: "SMS Fallback Network",
    desc: "If RCS is unavailable, automatically falls back to high-quality SMS routes.",
    color: "bg-[#FFC0CB]",
    icon: <Network size={28} className="text-white" />,
  },
  {
    title: "Real-Time Status & Events",
    desc: "Delivery reports, read receipts, and user events provide complete visibility.",
    color: "bg-[#7C3AED]",
      ...
      >
        ...
        {steps.map((step, i) => (
          ...
          >
            ...
            <p className="text-sm text-gray-650 leading-5">{step.desc}</p>
          </motion.div>
        ))}
      </motion.div>
